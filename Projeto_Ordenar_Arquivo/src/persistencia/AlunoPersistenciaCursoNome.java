 ...
 * @author Giu
 */
public abstract class AlunoPersistenciaCursoNome {
    
    //Atributos
    private String nomeDoArquivo;
    //Metodos
    public AlunoPersistenciaCursoNome(String curso,String nome){
        nomeDoArquivo = curso;
    }
    ...
    public ArrayList<Aluno> listagemDeAlunosCursoNome()throws Exception{
        try{
