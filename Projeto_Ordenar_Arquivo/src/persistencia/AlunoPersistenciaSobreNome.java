 ...
 * @author Giu
 */
public abstract class AlunoPersistenciaSobreNome {
    //Atributos
    private String nomeDoArquivo;
    //Metodos
    public AlunoPersistenciaSobreNome(String nome){
        nomeDoArquivo = nome;
    }
    ...
    public ArrayList<Aluno> listagemDeAlunosSobreNome()throws Exception{
        try{
