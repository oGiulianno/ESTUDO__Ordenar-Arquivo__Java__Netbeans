 ...
 * @author Giu
 */
public abstract class AlunoPersistenciaEnfaseCursoNome {
    //Atributos
    private String nomeDoArquivo;
    //Metodos
    public AlunoPersistenciaEnfaseCursoNome(String enfase, String curso,String nome){
    ...
    public ArrayList<Aluno> listagemDeAlunosEnfaseCursoNome()throws Exception{
        try{
