 ...
 * @author Giu
 */
public abstract class AlunoPersistenciaSituacaoCursoNome {
    //Atributos
    private String nomeDoArquivo;
    //Metodos
    public AlunoPersistenciaSituacaoCursoNome(String situacao, String curso,String nome){
        nomeDoArquivo = nome;
    }
    ...
    public ArrayList<Aluno> listagemDeAlunosSituacaoCursoNome()throws Exception{
        try{
