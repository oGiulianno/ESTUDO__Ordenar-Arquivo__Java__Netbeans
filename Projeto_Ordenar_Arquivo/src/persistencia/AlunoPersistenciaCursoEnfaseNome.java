 ...
 * @author Giu
 */
public abstract class AlunoPersistenciaCursoEnfaseNome {
    //Atributos
    private String nomeDoArquivo;
    //Metodos
    public AlunoPersistenciaCursoEnfaseNome(String curso, String enfase, String nome){
        nomeDoArquivo = curso;
    }
    ...
    public ArrayList<Aluno> listagemDeAlunosCursoEnfaseNome()throws Exception{
        try{
